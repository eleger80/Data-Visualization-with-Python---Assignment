...
app.layout = html.Div(children=[ 
                                ...
                                html.H1('Airline Dashboard', style={'textAlign': 'center', 'color': '#503D36', 'fontsize':40}),
                                ...
                                html.Div([
                                    ...
                                    html.Div([
                                        ...
                                        # Enter your code below. Make sure you have correct formatting.
                                      dcc.Dropdown(id='input-type', options=[{'Yearly Airline Performance Report':'OPT1' }, {'Yearly Airline Delay Report':'OPT2'}], placeholder='Select a report type', style={"width=80% ; padding=3px; font-size=20px; text-align-last=center"})   
